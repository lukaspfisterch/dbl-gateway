...
class ResolvedRef(TypedDict, total=False):
    ...
    admitted_for: str          # "governance" | "execution_only" | "model_context"
...
def _normalize_decision(decision: Mapping[str, Any]) -> DecisionNormative:
    ...
    normalized: DecisionNormative = {
        ...
        "identity_issuer": _normalize_optional_text(
            decision.get("identity_issuer"),
            field_name="identity_issuer",
        ),
